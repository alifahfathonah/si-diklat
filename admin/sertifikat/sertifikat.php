...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-pager ml-1 mr-1"></i> Data Sertifikat</h4>
                </div><!-- /.col -->
                    ...
                    <div class="card card-olive card-outline">
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="id_peserta" class="form-control select2" style="width: 100%;">
                                            ...
                                            <?php
                                            $dd = $con->query('SELECT id_peserta FROM sertifikat')->fetch_array();
                                            $dt = $con->query("SELECT * FROM kehadiran a JOIN peserta b ON a.id_peserta = b.id_peserta WHERE a.id_diklat = '$id' ORDER BY a.id_kehadiran ASC"); ?>
                                            <?php foreach ($dt as $r) : ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Link Sertifikat</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM sertifikat a JOIN peserta b ON a.id_peserta = b.id_peserta WHERE id_diklat = '$id' ORDER BY id_sertifikat DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center" width="5%">
                                                    <a href="hapus-sertifikat?id=<?= $row[0] ?>&idm=<?= $id ?>" class="btn btn-danger btn-xs alert-hapus mt-1" title="Hapus"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
...
if (isset($_POST['absen'])) {
    ...
    if ($query->num_rows > 0) {
        ...
        echo "<meta http-equiv='refresh' content='0; url=sertifikat?id=$id'>";
    } else {
        $tambah = $con->query("INSERT INTO sertifikat VALUES (
            default, 
            '$id',
            '$id_peserta',
            '$materi',
