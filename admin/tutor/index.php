...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-user-tie ml-1 mr-1"></i> Data Tutor</h4>
                </div><!-- /.col -->
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM tutor ORDER BY id_tutor DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $row['nm_tutor'] ?></td>
                                                <td>
                                                    <b>HP</b> : <?= $row['hp_tutor'] ?><br>
                                                    <b>Email</b> : <?= $row['email_tutor'] ?>
                                                </td>
                                                <td align="center"><?= $row['domisili'] ?></td>
